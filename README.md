...
| 07 | **[Gemini Vision KYC](./07_Gemini_Vision_KYC/)** | `Google Gemini 2.5 Flash` `Streamlit` `Guardrails` `Logging` `Evals` | 🛠️ **Live Product** | 🟢 **Live Demo**](https://ayush-fintech-copilot.streamlit.app/) |
